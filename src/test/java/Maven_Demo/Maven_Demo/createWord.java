...
{
  public static String GenerateDoc(String TC_ID)
    throws Exception
  {
    File theDir = new File(".\\src\\main\\resources\\com\\ibm\\stax\\Results\\Graphical Reporting\\Doc\\");
    if (!theDir.exists())
    {
      System.out.println("creating directory: .\\src\\main\\resources\\com\\ibm\\stax\\Results\\Graphical Reporting\\Doc\\");
    ...
    String filename = ".\\src\\main\\resources\\com\\ibm\\stax\\Results\\Graphical Reporting\\Doc\\" + TC_ID + "_" + timeStamp2 + ".docx";
  ...
  public static void endTest(String fileID)
    throws Exception
  {
    String timeStamp = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").format(Calendar.getInstance().getTime());
